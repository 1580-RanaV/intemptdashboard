          ...
          <div className="mb-4 flex w-full max-w-[875px] shrink-0 flex-wrap items-center justify-between gap-3">
            ...
            <div className="inline-flex shrink-0 overflow-hidden rounded-md bg-blue-50 text-xs font-medium text-blue-600 dark:bg-blue-500/12 dark:text-blue-300">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-1.5 px-2.5 py-1 transition-colors hover:bg-blue-100/70 dark:hover:bg-blue-500/18"
              >
                <ExternalLink size={13} />
                View public link
              </a>
              <span className="my-1 w-px bg-blue-200 dark:bg-blue-500/25" />
              <button
                type="button"
                onClick={() => navigator.clipboard?.writeText("https://intempt.com/share/meeting/rd-check-in")}
                className="inline-flex items-center gap-1.5 px-2.5 py-1 transition-colors hover:bg-blue-100/70 dark:hover:bg-blue-500/18"
              >
                <Copy size={13} />
                Copy link
