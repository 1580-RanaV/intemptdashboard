...
function Field({
  ...
  return (
    <label className="block">
      <span className="mb-1.5 block text-[12px] font-semibold text-stone-700 dark:text-stone-300">{label}</span>
      {children}
    </label>
  );
}
  ...
  return (
    <div ref={containerRef} className={`relative ${width}`}>
      <button
        ...
        className="flex h-9 w-full items-center justify-between gap-2 rounded-lg border border-stone-200 bg-white px-3 text-left text-[12.5px] font-medium text-stone-900 outline-none transition-colors hover:bg-stone-50 dark:border-stone-700 dark:bg-white/[0.03] dark:text-stone-100 dark:hover:bg-white/6"
      >
    ...
    <section className="py-2">
      <div className="mb-3 flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <h3 className="text-[13.5px] font-semibold text-stone-900 dark:text-stone-100">{title}</h3>
          {description ? <p className="mt-1 text-[12.5px] leading-5 text-stone-500 dark:text-stone-400">{description}</p> : null}
        </div>
      </div>
    ...
    >
      <div className="space-y-4">
        <div className="space-y-1">
          <h3 className="text-[17px] font-semibold text-stone-900 dark:text-stone-100">Untitled</h3>
          <p className="mt-1 text-[13px] font-medium text-stone-500 dark:text-stone-400">Individual (one-on-one)</p>
        </div>

        <Field label="Event name">
          <TextInput defaultValue="Untitled" />
        </Field>
        ...
        >
          <div className="space-y-3">
            <div className="flex items-center gap-2 text-[13px] font-semibold text-stone-900 dark:text-stone-100">
              <Shield size={15} className="text-stone-500 dark:text-stone-400" />
              When I say:
            </div>
            <p className="text-[12.5px] leading-5 text-stone-500 dark:text-stone-400">
        ...
        >
          <div className="mt-4 flex items-center justify-between gap-3">
            <span className="text-[13px] font-semibold text-stone-900 dark:text-stone-100">Use global hours</span>
        ...
        <Section icon={<CalendarDays size={16} />} title="Booking window">
          <div className="mt-4 flex flex-wrap items-center gap-2 text-[12.5px] font-medium text-stone-500 dark:text-stone-400">
