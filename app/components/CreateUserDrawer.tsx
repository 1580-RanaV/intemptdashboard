...
function Field({
  ...
  return (
    <label className="block">
      <span className="mb-1.5 block text-[12px] font-medium text-stone-700 dark:text-stone-300">
        {label}
        {required ? <span className="ml-1 text-stone-500">*</span> : null}
      </span>
      <input
        placeholder={placeholder}
        className="h-10 w-full rounded-lg border border-stone-200 bg-white px-3 text-[13px] font-normal text-stone-900 outline-none transition-colors placeholder:text-stone-400 focus:border-blue-400 focus:ring-2 focus:ring-blue-500/10 dark:border-stone-700 dark:bg-white/[0.035] dark:text-stone-100 dark:placeholder:text-stone-500"
      />
    </label>
  );
}
  ...
  return (
    ...
    >
      <div className="space-y-6 pt-1">
        ...
        <label className="block">
          <span className="mb-1.5 block text-[12px] font-medium text-stone-700 dark:text-stone-300">Lead stage</span>
          <select className="h-10 w-full rounded-lg border border-stone-200 bg-white px-3 text-[13px] font-normal text-stone-900 outline-none transition-colors focus:border-blue-400 focus:ring-2 focus:ring-blue-500/10 dark:border-stone-700 dark:bg-white/[0.035] dark:text-stone-100">
